...
# -------------------------
# Load and prepare local data (client 2's portion)
# -------------------------
...
# Split data between 3 clients (client 2)
_, X_train, _, y_train = train_test_split(X, y, test_size=0.6, random_state=42)  # Client 2 gets the second 1/3 of the data
...
def on_message(client, userdata, msg):
    ...
    if "weights" in data:
        ...
        update_data = {"client_id": "client_2", "weights": [w.tolist() for w in new_weights]}
...
mqtt_client = mqtt.Client("client_2")
mqtt_client.on_connect = on_connect
mqtt_client.on_message = on_message

mqtt_client.connect(BROKER_IP, MQTT_PORT, keepalive=60)

print("🚀 Client 2 Started. Waiting for updates from server...")
